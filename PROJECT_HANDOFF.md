...
- 内容编辑器：先按具体社媒账号多选，再编辑基础/平台版本文案、可选网站链接与表情/特殊符号、上传图片/视频素材；支持立即发布、北京时间 24 小时制定时发布和保存草稿。
...
- 内容编辑器：可勾选同一平台下的多个具体账号；每个已选账号生成独立变体/发布任务，支持基础文案、平台版本编辑、可选网站链接、表情/特殊符号插入、按平台独立的图片/视频素材和发布摘要。
...
- 内容编辑器中图片/视频上传入口。
- 上传后预览缩略图。
- 素材按平台独立配置：Instagram、Facebook、YouTube 等互不混用；同一平台的多个已选账号共享该平台素材。
- 内容预览中展示图片/视频。
- 发布任务可关联素材。
